...
public final class listarProdutos_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  daoProdutos dao = new daoProdutos();
   ...
   List<modeloProdutos> listap = dao.getAllProdutos();
    out.print("teste"+listap.size());
      ...
      out.write("            <thead>\n");
      out.write("                <tr>\n");
      out.write("                    <td>Id Produto: </td>\n");
      out.write("                    <td>Descricao: </td>\n");
      out.write("                    <td>Preco Unitario: </td>\n");
      out.write("                    <td>Preco Venda: </td>\n");
      out.write("                    <td>Estoque: </td>\n");
      out.write("                    <td>Id Fornecedor: </td>\n");
      out.write("                </tr>    \n");
      out.write("            </thead>\n");
      out.write("            \n");
      out.write("            <tbody>\n");
 ...
 for(modeloProdutos produto : listap){ 
      ...
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( produto.getPrecoUnitario() );
      out.write("</td>\n");
      out.write("                    <td>");
      ...
      out.write("</td>\n");
      out.write("                    <td>");
      out.print( produto.getId_fornecedor() );
      out.write("</td>\n");
      out.write("                </tr>\n");
      out.write("                 ");
} 
